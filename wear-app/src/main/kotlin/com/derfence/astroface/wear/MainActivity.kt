...
class MainActivity : Activity() {
    ...
    private fun refreshStatus() {
        ...
        statusView.text = buildString {
            ...
            appendLine("Service constellations : prêt")
            appendLine("Service horizon céleste : prêt")
            ...
            appendLine()
            appendLine("Dernière requête constellations :")
            appendLine(status.lastConstellationBackground ?: "aucune")
            appendLine()
            appendLine("Dernière requête horizon céleste :")
