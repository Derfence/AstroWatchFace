...
- `watch-face` est une Face WFF sans code, responsable du rendu numérique du cadran 24 h, de l'assemblage des couches, du séparateur « maintenant », des aiguilles et de la batterie.
